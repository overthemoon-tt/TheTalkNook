...
import { R as Route$3, s as supabase } from "./router-CO6Xqijl.mjs";
import { a as createServerFn, T as TSS_SERVER_FUNCTION, g as getServerFnById } from "./server-Bbx4d5Fx.mjs";
...
})).handler(createSsrRpc("96c8deb2eeea00f12084f43dcfec35745451684544f42f101ff4819dfdf40117"));
const SERVICES = {
  text_peer: {
    label: "Text Venting",
    mins: 25,
