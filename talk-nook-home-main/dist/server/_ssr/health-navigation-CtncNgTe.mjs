...
function HealthPage() {
  return /* @__PURE__ */ _libs_react.jsxRuntimeExports.jsxs(SiteShellCxrl0jzj.SiteShell, { children: [
    ...
    /* @__PURE__ */ _libs_react.jsxRuntimeExports.jsxs("section", { className: "mx-auto max-w-3xl px-5 pb-20", children: [
      ...
      /* @__PURE__ */ _libs_react.jsxRuntimeExports.jsx(accordionBK2cthPu.Accordion, { type: "single", collapsible: true, className: "space-y-2", children: [["Can I get a diagnosis here?", "No. Our navigators do not diagnose, prescribe, or replace a doctor."], ["Is this confidential?", "Yes. Conversations stay between you and the navigator."], ["What if it's urgent?", "If you think this is an emergency, go to the nearest hospital immediately."]].map(([q, a]) => /* @__PURE__ */ _libs_react.jsxRuntimeExports.jsxs(accordionBK2cthPu.AccordionItem, { value: q, className: "rounded-2xl border border-border bg-card px-5", children: [
        /* @__PURE__ */ _libs_react.jsxRuntimeExports.jsxs(accordionBK2cthPu.AccordionTrigger, { className: "text-left font-serif text-base flex items-center gap-2", children: [
