...
import { v as defineHandlerCallback, w as resolveManifestAssetLink, x as resolveManifestCssLink, y as rootRouteId, z as getNormalizedURL, A as getOrigin, C as normalizeSsrResponse, D as attachRouterServerSsrUtils, E as createSerializationAdapter, F as createRawStreamRPCPlugin, G as invariant, H as isNotFound, I as isRedirect, J as isResolvedRedirect, K as replaceSsrResponse, L as mergeHeaders, M as executeRewriteInput, N as stripSsrResponseBody, O as defaultSerovalPlugins, P as makeSerovalPlugin, Q as getScriptPreloadAttrs, S as getStylesheetHref, T as isSsrResponse, U as parseRedirect } from "../_libs/tanstack__router-core.mjs";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-fa4evjwC.mjs");
...
const manifest = {
  "96c8deb2eeea00f12084f43dcfec35745451684544f42f101ff4819dfdf40117": {
    functionName: "notifyBooking_createServerFn_handler",
    importer: () => import("./notify-booking-4bmVCiE5.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-BP_jko0A.mjs").then((n) => n.r),
    import("./start-BlISzbgI.mjs"),
